...
ylabel('C_{Di}');
title('Coefficiente di Resistenza Indotta vs Angolo di Attacco', 'FontSize', 16);
grid on;
legend('Cessna 172 Skyhawk', 'Tecnam P2008', 'Location', 'Best');
...
figure;
plot(y_Cessna, LiftDistribution_Cessna, 'o-',  'Color', [0 0.4470 0.7410], 'LineWidth', 1.2);
hold on;
plot(y_Cessna, Gamma_elliptic_Cessna, 'r--', 'LineWidth', 1.2);
hold on;
plot(y_Cessna, LiftDistribution_Tecnam, 'o-',  'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1.2);
hold on;
