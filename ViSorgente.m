function [U_s] = ViSorgente(Centro, Estremo_1, Estremo_2, L2G_TransfMatrix, G2L_TransfMatrix, is2Print)
...
u = -(0.5/pi) * log(norm(r2,'fro')/norm(r1,'fro'));
v = theta_2 - theta_1;
v = v / (2*pi);
...
%% Assegna il valore di U all'output U_s
