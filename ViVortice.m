function [U_v] = ViVortice(Centro, Estremo_1, Estremo_2, L2G_TransfMatrix, G2L_TransfMatrix)
...
u = theta_2 - theta_1;
u = u / (2*pi);
v = (0.5/pi) * log(norm(r2,'fro')/norm(r1,'fro'));
...
%% Assegna il valore di U all'output U_v
